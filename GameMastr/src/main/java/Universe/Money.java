...
public class Money {
    ...
    /**
     * Empty Constructor for return Objects methods
     */
    public Money(){}

    /***
     * Money instance with no value
     */
    ...
    public boolean equals(Object other) {
        if (other.getClass().equals(this.getClass())){
            return (this.convertInKreuzer().equals(((Money)other).convertInKreuzer()));
        }
        return false;
    }
}
