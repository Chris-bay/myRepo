...
public class MediaMultipleChoiceQuestion implements Question{
    Integer id;
    Integer points;
    String questionText;
    Integer answer;
    ...
    public MediaMultipleChoiceQuestion(Integer id, String question, String[] answers, Integer rightAnswer){
        this.Question(id, question, answers, rightAnswer);
    }

    public MediaMultipleChoiceQuestion(Integer id, String question, String[] answers){
